...
@Listeners({GiftOptions.class})

public class GiftOptions extends TestListenerAdapter{
  ...
  public void onTestSuccess(ITestResult result) {
	  try {
		...
		e.printStackTrace();
		  ...
		  Reporter.log("\n TestCase : GiftOptions - "+k.currenttestReportStmnt );
  }
  ...
  public Object [][] getData() throws IOException{
	  ...
	  data = TestUtil.getData( "GiftOptions", xls);
	  return data;
  }
