...
@Listeners({VerifyTodaySpecial.class})

public class VerifyTodaySpecial extends TestListenerAdapter{
  ...
  public void do_VerifyTodaySpecial( Hashtable <String,String> testData) throws Throwable {
	  
	  KeywordExecutor ke = new KeywordExecutor();
	  
	  System.out.println("going to run  "+this.getClass().getName()+" with data "+testData.toString());
	  ke.ExecuteKeywords("VerifyTodaySpecial", testData);
  ...
  public void onTestSuccess(ITestResult result) {
	  try {
		...
		e.printStackTrace();
		  ...
		  Reporter.log("\n TestCase : VerifyTodaySpecial - "+k.currenttestReportStmnt );
  }
  ...
  public Object [][] getData() throws IOException{
	  ...
	  data = TestUtil.getData( "VerifyTodaySpecial", xls);
	  return data;
  }
