...
@Listeners({CheckoutWithLightUserHotState.class})

public class CheckoutWithLightUserHotState extends TestListenerAdapter{
  ...
  public void do_CheckoutWithLightUserColdState( Hashtable <String,String> testData) throws Throwable {
	  ...
	  ke.ExecuteKeywords("CheckoutWithLightUserHotState", testData);
  ...
  public void onTestSuccess(ITestResult result) {
	  try {
		...
		e.printStackTrace();
		  ...
		  Reporter.log("\n TestCase : CheckoutWithLightUserHotState - "+k.currenttestReportStmnt );
  }
  ...
  public Object [][] getData() throws IOException{
	  ...
	  data = TestUtil.getData( "CheckoutWithLightUserHotState", xls);
	  return data;
  }
