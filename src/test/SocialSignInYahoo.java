...
@Listeners({SocialSignInYahoo.class})

public class SocialSignInYahoo extends TestListenerAdapter{
  ...
  public void do_SocialSignInYahoo( Hashtable <String,String> testData) throws Throwable {
	  
	  KeywordExecutor ke = new KeywordExecutor();
	  
	  System.out.println("going to run  "+this.getClass().getName()+" with data "+testData.toString());
	  ke.ExecuteKeywords("SocialSignInYahoo", testData);
  ...
  public void onTestSuccess(ITestResult result) {
	  try {
		...
		e.printStackTrace();
		  ...
		  Reporter.log("\n TestCase : SocialSignInYahoo - "+k.currenttestReportStmnt );
  }
  ...
  public Object [][] getData() throws IOException{
	  ...
	  data = TestUtil.getData( "SocialSignInYahoo", xls);
	  return data;
  }
