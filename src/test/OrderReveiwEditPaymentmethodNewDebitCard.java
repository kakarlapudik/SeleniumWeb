...
@Listeners({OrderReveiwEditPaymentmethodNewDebitCard.class})

public class OrderReveiwEditPaymentmethodNewDebitCard extends TestListenerAdapter{
  ...
  public void do_OrderReveiwEditPaymentmethodNewDebitCard( Hashtable <String,String> testData) throws Throwable {
	  
	  KeywordExecutor ke = new KeywordExecutor();
	  
	  System.out.println("going to run  "+this.getClass().getName()+" with data "+testData.toString());
	  ke.ExecuteKeywords("OrderReveiwEditPaymentmethodNewDebitCard", testData);
  ...
  public void onTestSuccess(ITestResult result) {
	  try {
		...
		e.printStackTrace();
		  ...
		  Reporter.log("\n TestCase : OrderReveiwEditPaymentmethodNewDebitCard - "+k.currenttestReportStmnt );
  }
  ...
  public Object [][] getData() throws IOException{
	  ...
	  data = TestUtil.getData( "OrderReveiwEditPaymentmethodNewDebitCard", xls);
	  return data;
  }
