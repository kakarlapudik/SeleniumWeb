...
@Listeners({CheckoutWithPromotion.class})

public class CheckoutWithPromotion extends TestListenerAdapter{
  ...
  public void do_CheckoutWithPromotion( Hashtable <String,String> testData) throws Throwable {
	  
	  KeywordExecutor ke = new KeywordExecutor();
	  
	  System.out.println("going to run  "+this.getClass().getName()+" with data "+testData.toString());
	  ke.ExecuteKeywords("CheckoutWithPromotion", testData);
  ...
  public void onTestSuccess(ITestResult result) {
	  try {
		...
		e.printStackTrace();
		  ...
		  Reporter.log("\n TestCase : CheckoutWithPromotion - "+k.currenttestReportStmnt );
  }
  ...
  public Object [][] getData() throws IOException{
	  ...
	  data = TestUtil.getData( "CheckoutWithPromotion", xls);
	  return data;
  }
