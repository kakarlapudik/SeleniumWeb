...
@Listeners({ManageAutoshipAddNewCC.class})

public class ManageAutoshipAddNewCC extends TestListenerAdapter{
  ...
  public void do_ManageAutoshipAddNewCC( Hashtable <String,String> testData) throws Throwable {
	  
	  KeywordExecutor ke = new KeywordExecutor();
	  
	  System.out.println("going to run  "+this.getClass().getName()+" with data "+testData.toString());
	  ke.ExecuteKeywords("ManageAutoshipAddNewCC", testData);
  ...
  public void onTestSuccess(ITestResult result) {
	  try {
		...
		e.printStackTrace();
		  ...
		  Reporter.log("\n TestCase : ManageAutoshipAddNewCC - "+k.currenttestReportStmnt );
  }
  ...
  public Object [][] getData() throws IOException{
	  ...
	  data = TestUtil.getData( "ManageAutoshipAddNewCC", xls);
	  return data;
  }
