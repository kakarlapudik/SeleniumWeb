...
@Listeners({MobileExistingUserAddCC.class})

public class MobileExistingUserAddCC extends TestListenerAdapter{
  ...
  public void do_MobileExistingUserAddCC( Hashtable <String,String> testData) throws Throwable {
	  
	  KeywordExecutor ke = new KeywordExecutor();
	  
	  System.out.println("going to run  "+this.getClass().getName()+" with data "+testData.toString());
	  ke.ExecuteKeywords("MobileExistingUserAddCC", testData);
  ...
  public void onTestSuccess(ITestResult result) {
	  try {
		...
		e.printStackTrace();
		  ...
		  Reporter.log("\n TestCase : MobileExistingUserAddCC - "+k.currenttestReportStmnt );
  }
