...
@Listeners({ManageFlexPayAddNewCC.class})

public class ManageFlexPayAddNewCC extends TestListenerAdapter{
  ...
  public void do_ManageFlexPayAddNewCC( Hashtable <String,String> testData) throws Throwable {
	  
	  KeywordExecutor ke = new KeywordExecutor();
	  
	  System.out.println("going to run  "+this.getClass().getName()+" with data "+testData.toString());
	  ke.ExecuteKeywords("ManageFlexPayAddNewCC", testData);
  ...
  public void onTestSuccess(ITestResult result) {
	  try {
		...
		e.printStackTrace();
		  ...
		  Reporter.log("\n TestCase : ManageFlexPayAddNewCC - "+k.currenttestReportStmnt );
  }
  ...
  public Object [][] getData() throws IOException{
	  ...
	  data = TestUtil.getData( "ManageFlexPayAddNewCC", xls);
	  return data;
  }
