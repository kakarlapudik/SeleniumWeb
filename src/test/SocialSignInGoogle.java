...
@Listeners({SocialSignInGoogle.class})

public class SocialSignInGoogle extends TestListenerAdapter{
  ...
  public void do_SocialSignInGoogle( Hashtable <String,String> testData) throws Throwable {
	  
	  KeywordExecutor ke = new KeywordExecutor();
	  
	  System.out.println("going to run  "+this.getClass().getName()+" with data "+testData.toString());
	  ke.ExecuteKeywords("SocialSignInGoogle", testData);
  ...
  public void onTestSuccess(ITestResult result) {
	  try {
		...
		e.printStackTrace();
		  ...
		  Reporter.log("\n TestCase : SocialSignInGoogle - "+k.currenttestReportStmnt );
  }
  ...
  public Object [][] getData() throws IOException{
	  ...
	  data = TestUtil.getData( "SocialSignInGoogle", xls);
	  return data;
  }
