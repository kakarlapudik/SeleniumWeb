...
@Listeners({SocialSignInFacebook.class})

public class SocialSignInFacebook extends TestListenerAdapter{
  ...
  public void do_SocialSignInFacebook( Hashtable <String,String> testData) throws Throwable {
	  
	  KeywordExecutor ke = new KeywordExecutor();
	  
	  System.out.println("going to run  "+this.getClass().getName()+" with data "+testData.toString());
	  ke.ExecuteKeywords("SocialSignInFacebook", testData);
  ...
  public void onTestSuccess(ITestResult result) {
	  try {
		...
		e.printStackTrace();
		  ...
		  Reporter.log("\n TestCase : SocialSignInFacebook - "+k.currenttestReportStmnt );
  }
  ...
  public Object [][] getData() throws IOException{
	  ...
	  data = TestUtil.getData( "SocialSignInFacebook", xls);
	  return data;
  }
