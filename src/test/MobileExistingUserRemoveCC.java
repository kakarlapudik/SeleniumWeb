...
@Listeners({MobileExistingUserRemoveCC.class})

public class MobileExistingUserRemoveCC extends TestListenerAdapter{
  ...
  public void do_MobileExistingUserRemoveCC( Hashtable <String,String> testData) throws Throwable {
	  
	  KeywordExecutor ke = new KeywordExecutor();
	  
	  System.out.println("going to run  "+this.getClass().getName()+" with data "+testData.toString());
	  ke.ExecuteKeywords("MobileExistingUserRemoveCC", testData);
  ...
  public void onTestSuccess(ITestResult result) {
	  try {
		...
		e.printStackTrace();
		  ...
		  Reporter.log("\n TestCase : MobileExistingUserRemoveCC - "+k.currenttestReportStmnt );
  }
  ...
  public Object [][] getData() throws IOException{
	  ...
	  data = TestUtil.getData( "MobileExistingUserRemoveCC", xls);
	  return data;
  }
