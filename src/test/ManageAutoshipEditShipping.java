...
@Listeners({ManageAutoshipEditShipping.class})

public class ManageAutoshipEditShipping extends TestListenerAdapter{
  ...
  public void do_ManageAutoshipEditShipping( Hashtable <String,String> testData) throws Throwable {
	  
	  KeywordExecutor ke = new KeywordExecutor();
	  
	  System.out.println("going to run  "+this.getClass().getName()+" with data "+testData.toString());
	  ke.ExecuteKeywords("ManageAutoshipEditShipping", testData);
  ...
  public void onTestSuccess(ITestResult result) {
	  try {
		...
		e.printStackTrace();
		  ...
		  Reporter.log("\n TestCase : ManageAutoshipEditShipping - "+k.currenttestReportStmnt );
  }
  ...
  public Object [][] getData() throws IOException{
	  ...
	  data = TestUtil.getData( "ManageAutoshipEditShipping", xls);
	  return data;
  }
