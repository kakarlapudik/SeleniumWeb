...
@Listeners({Emailsignup.class})

public class Emailsignup extends TestListenerAdapter{
  ...
  public void onTestSuccess(ITestResult result) {
	  try {
		...
		e.printStackTrace();
		  ...
		  Reporter.log("\n TestCase : Emailsignup - "+k.currenttestReportStmnt );
  }
  ...
  public Object [][] getData() throws IOException{
	  ...
	  data = TestUtil.getData( "Emailsignup", xls);
	  return data;
  }
