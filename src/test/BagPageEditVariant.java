...
@Listeners({BagPageEditVariant.class})

public class BagPageEditVariant extends TestListenerAdapter{
  ...
  public void do_BagPageEditVariant( Hashtable <String,String> testData) throws Throwable {
	  
	  KeywordExecutor ke = new KeywordExecutor();
	  
	  System.out.println("going to run  "+this.getClass().getName()+" with data "+testData.toString());
	  ke.ExecuteKeywords("BagPageEditVariant", testData);
  ...
  public void onTestSuccess(ITestResult result) {
	  try {
		...
		e.printStackTrace();
		  ...
		  Reporter.log("\n TestCase : BagPageEditVariant - "+k.currenttestReportStmnt );
  }
  ...
  public Object [][] getData() throws IOException{
	  ...
	  data = TestUtil.getData( "BagPageEditVariant", xls);
	  return data;
  }
