...
@Listeners({CheckMultiItemsWithCoupon.class})

public class CheckMultiItemsWithCoupon extends TestListenerAdapter{
  ...
  public void do_CheckMultiItemsWithCoupon( Hashtable <String,String> testData) throws Throwable {
	  
	  KeywordExecutor ke = new KeywordExecutor();
	  
	  System.out.println("going to run  "+this.getClass().getName()+" with data "+testData.toString());
	  ke.ExecuteKeywords("CheckMultiItemsWithCoupon", testData);
  ...
  public void onTestSuccess(ITestResult result) {
	  try {
		...
		e.printStackTrace();
		  ...
		  Reporter.log("\n TestCase : CheckMultiItemsWithCoupon - "+k.currenttestReportStmnt );
  }
  ...
  public Object [][] getData() throws IOException{
	  ...
	  data = TestUtil.getData( "CheckMultiItemsWithCoupon", xls);
	  return data;
  }
