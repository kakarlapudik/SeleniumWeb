...
@Listeners({OrderReveiwEditPaymentmethod.class})

public class OrderReveiwEditPaymentmethod extends TestListenerAdapter{
  ...
  public void do_OrderReveiwEditPaymentmethod( Hashtable <String,String> testData) throws Throwable {
	  
	  KeywordExecutor ke = new KeywordExecutor();
	  
	  System.out.println("going to run  "+this.getClass().getName()+" with data "+testData.toString());
	  ke.ExecuteKeywords("OrderReveiwEditPaymentmethod", testData);
  ...
  public void onTestSuccess(ITestResult result) {
	  try {
		...
		e.printStackTrace();
		  ...
		  Reporter.log("\n TestCase : OrderReveiwEditPaymentmethod - "+k.currenttestReportStmnt );
  }
  ...
  public Object [][] getData() throws IOException{
	  ...
	  data = TestUtil.getData( "OrderReveiwEditPaymentmethod", xls);
	  return data;
  }
