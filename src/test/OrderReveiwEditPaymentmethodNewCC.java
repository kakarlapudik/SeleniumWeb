...
@Listeners({OrderReveiwEditPaymentmethodNewCC.class})

public class OrderReveiwEditPaymentmethodNewCC extends TestListenerAdapter{
  ...
  public void do_OrderReveiwEditPaymentmethodNewCC( Hashtable <String,String> testData) throws Throwable {
	  
	  KeywordExecutor ke = new KeywordExecutor();
	  
	  System.out.println("going to run  "+this.getClass().getName()+" with data "+testData.toString());
	  ke.ExecuteKeywords("OrderReveiwEditPaymentmethodNewCC", testData);
  ...
  public void onTestSuccess(ITestResult result) {
	  try {
		...
		e.printStackTrace();
		  ...
		  Reporter.log("\n TestCase : OrderReveiwEditPaymentmethodNewCC - "+k.currenttestReportStmnt );
  }
  ...
  public Object [][] getData() throws IOException{
	  ...
	  data = TestUtil.getData( "OrderReveiwEditPaymentmethodNewCC", xls);
	  return data;
  }
