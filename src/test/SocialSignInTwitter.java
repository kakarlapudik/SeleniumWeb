...
@Listeners({SocialSignInTwitter.class})

public class SocialSignInTwitter extends TestListenerAdapter{
  ...
  public void do_SocialSignInTwitter( Hashtable <String,String> testData) throws Throwable {
	  
	  KeywordExecutor ke = new KeywordExecutor();
	  
	  System.out.println("going to run  "+this.getClass().getName()+" with data "+testData.toString());
	  ke.ExecuteKeywords("SocialSignInTwitter", testData);
  ...
  public void onTestSuccess(ITestResult result) {
	  try {
		...
		e.printStackTrace();
		  ...
		  Reporter.log("\n TestCase : SocialSignInTwitter - "+k.currenttestReportStmnt );
  }
  ...
  public Object [][] getData() throws IOException{
	  ...
	  data = TestUtil.getData( "SocialSignInTwitter", xls);
	  return data;
  }
