...
@Listeners({SuggestiveSearch.class})

public class SuggestiveSearch extends TestListenerAdapter{
  ...
  public void do_SuggestiveSearch( Hashtable <String,String> testData) throws Throwable {
	  
	  KeywordExecutor ke = new KeywordExecutor();
	  
	  System.out.println("going to run  "+this.getClass().getName()+" with data "+testData.toString());
	  ke.ExecuteKeywords("SuggestiveSearch", testData);
  ...
  public void onTestSuccess(ITestResult result) {
	  try {
		...
		e.printStackTrace();
		  ...
		  Reporter.log("\n TestCase : SuggestiveSearch - "+k.currenttestReportStmnt );
  }
  ...
  public Object [][] getData() throws IOException{
	  ...
	  data = TestUtil.getData( "SuggestiveSearch", xls);
	  return data;
  }
