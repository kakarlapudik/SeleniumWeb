...
@Listeners({ExchangeRegularItem.class})

public class ExchangeRegularItem extends TestListenerAdapter{
  ...
  public void do_ExchangeRegularItem( Hashtable <String,String> testData) throws Throwable {
	  
	  KeywordExecutor ke = new KeywordExecutor();
	  
	  System.out.println("going to run  "+this.getClass().getName()+" with data "+testData.toString());
	  ke.ExecuteKeywords("ExchangeRegularItem", testData);
  ...
  public void onTestSuccess(ITestResult result) {
	  try {
		...
		e.printStackTrace();
		  ...
		  Reporter.log("\n TestCase : ExchangeRegularItem - "+k.currenttestReportStmnt );
  }
  ...
  public Object [][] getData() throws IOException{
	  ...
	  data = TestUtil.getData( "ExchangeRegularItem", xls);
	  return data;
  }
