...
@Listeners({CheckTaxAndSavingsOnBagPage.class})

public class CheckTaxAndSavingsOnBagPage extends TestListenerAdapter{
  ...
  public void do_CheckTaxAndSavingsOnBagPage( Hashtable <String,String> testData) throws Throwable {
	  
	  KeywordExecutor ke = new KeywordExecutor();
	  
	  System.out.println("going to run  "+this.getClass().getName()+" with data "+testData.toString());
	  ke.ExecuteKeywords("CheckTaxAndSavingsOnBagPage", testData);
  ...
  public void onTestSuccess(ITestResult result) {
	  try {
		...
		e.printStackTrace();
		  ...
		  Reporter.log("\n TestCase : CheckTaxAndSavingsOnBagPage - "+k.currenttestReportStmnt );
  }
  ...
  public Object [][] getData() throws IOException{
	  ...
	  data = TestUtil.getData( "CheckTaxAndSavingsOnBagPage", xls);
	  return data;
  }
