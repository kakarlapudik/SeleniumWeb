...
@Listeners({PromoType_ExtraFlex.class})

public class PromoType_ExtraFlex extends TestListenerAdapter{
  ...
  public void do_PromoType_ExtraFlex( Hashtable <String,String> testData) throws Throwable {
	  
	  KeywordExecutor ke = new KeywordExecutor();
	  
	  System.out.println("going to run  "+this.getClass().getName()+" with data "+testData.toString());
	  ke.ExecuteKeywords("PromoType_ExtraFlex", testData);
  ...
  public void onTestSuccess(ITestResult result) {
	  try {
		...
		e.printStackTrace();
		  ...
		  Reporter.log("\n TestCase : PromoType_ExtraFlex - "+k.currenttestReportStmnt );
  }
  ...
  public Object [][] getData() throws IOException{
	  ...
	  data = TestUtil.getData( "PromoType_ExtraFlex", xls);
	  return data;
  }
