...
@Listeners({AddMeasurementsFunctionality.class})

public class AddMeasurementsFunctionality extends TestListenerAdapter{
  ...
  public void do_AddMeasurementsFunctionality( Hashtable <String,String> testData) throws Throwable {
	  
	  KeywordExecutor ke = new KeywordExecutor();
	  
	  System.out.println("going to run  "+this.getClass().getName()+" with data "+testData.toString());
	  ke.ExecuteKeywords("AddMeasurementsFunctionality", testData);
  ...
  public void onTestSuccess(ITestResult result) {
	  try {
		...
		e.printStackTrace();
		  ...
		  Reporter.log("\n TestCase : AddMeasurementsFunctionality - "+k.currenttestReportStmnt );
  }
  ...
  public Object [][] getData() throws IOException{
	  ...
	  data = TestUtil.getData( "AddMeasurementsFunctionality", xls);
	  return data;
  }
