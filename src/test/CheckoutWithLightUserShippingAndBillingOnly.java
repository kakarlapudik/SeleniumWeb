...
@Listeners({CreateLightUser.class})

public class CheckoutWithLightUserShippingAndBillingOnly extends TestListenerAdapter{
  ...
  public void do_SpreadTheWord ( Hashtable <String,String> testData) throws Throwable {
	  
	  KeywordExecutor ke = new KeywordExecutor();
	  
	  System.out.println("going to run  "+this.getClass().getName()+" with data "+testData.toString());
	  ke.ExecuteKeywords("CheckoutWithLightUserShippingAndBillingOnly", testData);
  ...
  public void onTestSuccess(ITestResult result) {
	  try {
		...
		e.printStackTrace();
		  ...
		  Reporter.log("\n TestCase : CheckoutWithLightUserShippingAndBillingOnly - "+k.currenttestReportStmnt );
  }
  ...
  public Object [][] getData() throws IOException{
	  ...
	  data = TestUtil.getData( "CheckoutWithLightUserShippingAndBillingOnly", xls);
	  return data;
  }
